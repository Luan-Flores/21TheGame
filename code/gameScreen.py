...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelCarta.setStyleSheet("")
        self.labelCarta.setText("")
        self.labelCarta.setTextFormat(QtCore.Qt.RichText)
        self.labelCarta.setPixmap(QtGui.QPixmap("../baralhos/cartaFUNDO.png"))
        self.labelCarta.setScaledContents(True)
        self.labelCarta.setObjectName("labelCarta")
        self.labelCartas = QtWidgets.QLabel(self.centralwidget)
        self.labelCartas.setGeometry(QtCore.QRect(220, 470, 141, 221))
        self.labelCartas.setText("")
        self.labelCartas.setPixmap(QtGui.QPixmap("baralhos/2P.png"))
        self.labelCartas.setScaledContents(True)
        self.labelCartas.setObjectName("labelCartas")
        ...
        self.label.setGeometry(QtCore.QRect(980, 470, 141, 221))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("baralhos/5E.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.labelCarta_2 = QtWidgets.QLabel(self.centralwidget)
        self.labelCarta_2.setGeometry(QtCore.QRect(1170, 470, 141, 221))
        self.labelCarta_2.setStyleSheet("\n"
"")
        self.labelCarta_2.setText("")
        self.labelCarta_2.setPixmap(QtGui.QPixmap("baralhos/JE.png"))
        self.labelCarta_2.setScaledContents(True)
        self.labelCarta_2.setObjectName("labelCarta_2")
